    ...
    <main className="main-page">
      <div className="row">
        <div className="col-md-7">
          ...
          <div className="mb-5">
            <Link to="/get-your-pizza" className="hfx-bounce btn btn-primary btn-lg px-4">
              Start Ordering
            </Link>
          </div>
        </div>
      ...
      <p className="fs-5 col-md-12">We love pizza but do you love pizza too?</p>
      <p className="fs-5 col-md-10">
        How it works is simple -- order one pizza for yourself and it's free on
        us. That's right it's absolutely free!
      </p>
      ...
      <div className="mt-2 row g-5">
        <div className="col-md-6">
          ...
          <p>
            We offer a variety of different types of Pizza's with more to come.
          </p>
